...
#' @rdname ggcorrplot
#' @export
ggcorrplot_v2 <- function (corr, method = c("square", "circle"),
                        ...
                        tl.cex = 12, tl.col = "black", tl.srt = 45, lim = c(-1,1)) {
  ...
  p <-
    ...
    ggplot2::theme(
      ...
      legend.title = ggplot2::element_text(size = tl.cex),
      legend.text = ggplot2::element_text(size = tl.cex-2)
      #legend.title.margin = margin(10,10,10,10, "pt")
